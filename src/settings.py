...
PAPER: Optional[Union[str, List[str], Dict[str, str]]] = {
    "Labeling Methodology": "https://drive.google.com/file/d/1k5r4mMRD8123N7q-4D3APnwkpER8G6lw/view"
}
...
AUTHORS_CONTACTS: Optional[List[str]] = ["ramon.morros@upc.edu"]
